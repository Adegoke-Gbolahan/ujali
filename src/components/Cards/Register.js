...
import FacebookIcon from "../../assests/images/icon/facebook.png";
import GoogleIcon from "../../assests/images/icon/google1.png";
const LoginCard = () => {
              ...
              <div className="lg:w-4/5 md:w-4/5 sm:w-full">
                ...
                Sign Up
                  ...
                  <form>
                    ...
                    <div className="float-right w-1/2  lg:mr-12 ">
